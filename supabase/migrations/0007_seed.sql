...
--
-- Scores go in base_score AND score: base_score is the imported baseline real
-- votes accumulate on top of, score is the materialised total the triggers
-- maintain from here on.
...
values
  ...
  ('22222222-2222-4222-8222-000000000007', 'MusicClub', 'Music Club',
   ...
   'blue', array['club','music','arts'], 2640, 173, now() - interval '860 days'),
  ...
  ('22222222-2222-4222-8222-000000000008', 'SciTechClub', 'Science & Technology Club',
   ...
   'teal_deep', array['club','stem','projects'], 4180, 268, now() - interval '940 days'),
  ...
  ('22222222-2222-4222-8222-000000000009', 'PhotographyClub', 'Photography Club',
   ...
   'navy', array['club','photography','arts'], 1990, 121, now() - interval '720 days'),
  ...
  ('22222222-2222-4222-8222-000000000010', 'SportsClub', 'Sports Club',
   ...
   'emerald', array['club','sports','fitness'], 5240, 302, now() - interval '1150 days'),
  ...
  ('22222222-2222-4222-8222-000000000011', 'DebateClub', 'Debate & Literary Club',
   ...
   'green', array['club','debate','writing'], 1760, 88, now() - interval '680 days')
on conflict do nothing;
...
values
  ('33333333-3333-4333-8333-000000000001',
   ...
   'Discussion', 342, 342, now() - interval '3 hours'),
  ...
  ('33333333-3333-4333-8333-000000000002',
   ...
   'Resource', 918, 918, now() - interval '9 hours'),
  ...
  ('33333333-3333-4333-8333-000000000003',
   ...
   'Event', 205, 205, now() - interval '5 hours'),
  ...
  ('33333333-3333-4333-8333-000000000004',
   ...
   'Help', 156, 156, now() - interval '1 hour'),
  ...
  ('33333333-3333-4333-8333-000000000005',
   ...
   'Guide', 274, 274, now() - interval '20 hours'),
  ...
  ('33333333-3333-4333-8333-000000000006',
   ...
   'Project', 431, 431, now() - interval '14 hours'),
  ...
  ('33333333-3333-4333-8333-000000000007',
   ...
   'Discussion', 189, 189, now() - interval '30 hours'),
  ...
  ('33333333-3333-4333-8333-000000000008',
   ...
   'Study Group', 97, 97, now() - interval '2 hours'),
  ...
  ('33333333-3333-4333-8333-000000000009',
   ...
   'Event', 168, 168, now() - interval '4 hours'),
  ...
  ('33333333-3333-4333-8333-000000000010',
   ...
   'Event', 289, 289, now() - interval '7 hours'),
  ...
  ('33333333-3333-4333-8333-000000000011',
   ...
   'Challenge', 142, 142, now() - interval '11 hours'),
  ...
  ('33333333-3333-4333-8333-000000000012',
   ...
   'Announcement', 231, 231, now() - interval '6 hours'),
  ...
  ('33333333-3333-4333-8333-000000000013',
   ...
   'Discussion', 114, 114, now() - interval '9 hours')
on conflict do nothing;
