...
export function SearchBox() {
  ...
  return (
    <div className="relative mx-auto w-full min-w-0 md:max-w-md">
      ...
      <input
        ...
        className="h-9 w-full min-w-0 rounded-full border border-input bg-secondary/60 pl-8 pr-2.5 text-sm outline-none transition-colors focus-visible:border-ring focus-visible:bg-background focus-visible:ring-3 focus-visible:ring-ring/40 sm:pl-9 sm:pr-3"
      />
    </div>
  )
}
